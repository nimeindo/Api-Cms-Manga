...
class CronDetailMangaGenerateByAlfabet extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'CronDetailMangaGenerateByAlfabet:CronDetailMangaGenerateByAlfabetV1  {start_by_index} {end_by_index} ';
     ...
     * @var string
     */
    protected $description = 'Cron untuk generate data CronDetailMangaGenerateByAlfabet';
    ...
    public function handle(){
        ...
        $filename = $path_log.'/DetaillistMangaGenerateByAlfabetV1.json';
        ...
        foreach($listManga as $listManga){
            ...
            try{
                $data = $this->DetailMangaController->DetailMangaScrap(NULL,$listDataAnime);
