...
class CronLastUpdateChapterMangaGenerateDsc extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'CronLastUpdateChapterMangaGenerateDsc:CronLastUpdateChapterMangaGenerateDscV1  {page_number_first} {page_number_end} {all_list}';
     ...
     * @var string
     */
    protected $description = 'Cron untuk generate data CronLastUpdateChapterMangaGenerateDscV1';
